...
EN = {
    ...
    "state_no_image": "Camera gives no picture - reopening it",
    "state_no_image_lid": "Lid is closed - the camera is inside it",
    "rate": "Blink rate: {rate}/min",
    "rate_unknown": "Blink rate: measuring…",
    "signal_weak": "Weak signal - blinks are barely visible",
    "pause": "Pause",
    "resume": "Resume",
    "snooze": "Pause for…",
    ...
    "rate_total": "Blink rate: {rate}/min · {total} this session",
    "rate_unknown_total": "Blink rate: measuring… · {total} this session",
    "timing_countdown": "No blink for {seconds} s of {interval}",
    "timing_hold": "Quiet after a reminder: {seconds} s left",
    "timing_idle": "Not counting right now",
    "timing_no_face": "Face not in view - countdown on hold",
    "timing_calibrating": "Calibrating - countdown starts in a moment",
    "timing_unusable": "Blinks not measurable - no reminders until they are",
    "menubar_extra": "Next to the menu bar icon",
    "menubar_none": "Nothing",
    "menubar_rate": "Blink rate",
    "menubar_count": "Blink counter",
...
RU = {
    ...
    "state_no_image": "Камера не даёт изображения — переоткрываю",
    "state_no_image_lid": "Крышка закрыта — камера внутри неё",
    "rate": "Частота: {rate} в минуту",
    "rate_unknown": "Частота: измеряю…",
    "signal_weak": "Слабый сигнал — моргания едва различимы",
    "pause": "Пауза",
    "resume": "Продолжить",
    "snooze": "Пауза на…",
    "snooze_15": "15 минут",
    ...
    "rate_total": "Частота: {rate} в минуту · {total} за сеанс",
    "rate_unknown_total": "Частота: измеряю… · {total} за сеанс",
    "timing_countdown": "Без моргания: {seconds} с из {interval}",
    "timing_hold": "Тишина после сигнала: ещё {seconds} с",
    "timing_idle": "Сейчас не считаю",
    "timing_no_face": "Лицо не в кадре — отсчёт остановлен",
    "timing_calibrating": "Калибровка — отсчёт начнётся через мгновение",
    "timing_unusable": "Моргания не измеряются — напоминаний не будет",
    "menubar_extra": "Рядом со значком в строке меню",
    "menubar_none": "Ничего",
    "menubar_rate": "Частоту морганий",
    "menubar_count": "Счётчик морганий",
